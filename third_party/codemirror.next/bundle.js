...
export { acceptCompletion, autocompletion, closeBrackets, closeBracketsKeymap, closeCompletion, completeAnyWord, CompletionContext, completionStatus, currentCompletions, ifNotIn, moveCompletionSelection, selectedCompletion, selectedCompletionIndex, startCompletion } from '@codemirror/autocomplete';
...
export { bracketMatching, codeFolding, bidiIsolates, ensureSyntaxTree, foldGutter, foldKeymap, HighlightStyle, indentOnInput, indentUnit, Language, LanguageSupport, StreamLanguage, StringStream, syntaxHighlighting, syntaxTree } from '@codemirror/language';
...
export async function cssStreamParser() {
    return (await import('@codemirror/legacy-modes/mode/css')).css;
}
export function vue() {
